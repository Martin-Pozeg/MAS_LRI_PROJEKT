...
--Command     : generate_target b_d_wrapper.bd
--Design      : b_d_wrapper
...
entity b_d_wrapper is
  port (
    ...
    IIC_SCCB_scl_io : inout STD_LOGIC;
    IIC_SCCB_sda_io : inout STD_LOGIC;
    XCLK : out STD_LOGIC;
...
architecture STRUCTURE of b_d_wrapper is
  component b_d is
  port (
    FIXED_IO_mio : inout STD_LOGIC_VECTOR ( 53 downto 0 );
    FIXED_IO_ddr_vrn : inout STD_LOGIC;
  ...
  signal IIC_SCCB_scl_i : STD_LOGIC;
  signal IIC_SCCB_scl_o : STD_LOGIC;
  signal IIC_SCCB_scl_t : STD_LOGIC;
  signal IIC_SCCB_sda_i : STD_LOGIC;
  signal IIC_SCCB_sda_o : STD_LOGIC;
  signal IIC_SCCB_sda_t : STD_LOGIC;
...
begin
IIC_SCCB_scl_iobuf: component IOBUF
     port map (
      I => IIC_SCCB_scl_o,
      IO => IIC_SCCB_scl_io,
      O => IIC_SCCB_scl_i,
...
IIC_SCCB_sda_iobuf: component IOBUF
     port map (
      I => IIC_SCCB_sda_o,
      IO => IIC_SCCB_sda_io,
      O => IIC_SCCB_sda_i,
...
b_d_i: component b_d
     port map (
      CAMERA_tri_i(10 downto 0) => CAMERA_tri_i(10 downto 0),
      ...
      IIC_SCCB_scl_i => IIC_SCCB_scl_i,
      IIC_SCCB_scl_o => IIC_SCCB_scl_o,
      IIC_SCCB_scl_t => IIC_SCCB_scl_t,
      IIC_SCCB_sda_i => IIC_SCCB_sda_i,
      IIC_SCCB_sda_o => IIC_SCCB_sda_o,
      IIC_SCCB_sda_t => IIC_SCCB_sda_t,
      XCLK => XCLK,
