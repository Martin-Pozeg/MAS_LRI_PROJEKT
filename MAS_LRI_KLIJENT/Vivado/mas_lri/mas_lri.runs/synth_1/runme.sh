...
HD_PWD='C:/MAS_LRI/mas_lri/mas_lri.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b_d_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b_d_wrapper.tcl
