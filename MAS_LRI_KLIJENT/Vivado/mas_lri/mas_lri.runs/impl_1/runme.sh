...
HD_PWD='C:/MAS_LRI/mas_lri/mas_lri.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log b_d_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source b_d_wrapper.tcl -notrace
