...
HD_PWD='D:/MAS_LRI/mas_lri/mas_lri.runs/b_d_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b_d_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b_d_axi_gpio_1_0.tcl
