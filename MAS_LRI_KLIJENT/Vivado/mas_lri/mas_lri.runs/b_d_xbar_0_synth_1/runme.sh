...
HD_PWD='C:/MAS_LRI/mas_lri/mas_lri.runs/b_d_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b_d_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b_d_xbar_0.tcl
